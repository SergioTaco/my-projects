...
# it takes parameters from query string on URL, assign that parameter to the 'user' variable and sent that user 
# name into the html file. If it doesn't have any parameter, warning massage is raised
